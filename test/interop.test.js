...
import test from "ava";
import { makeFunction } from "../src/interop.js";
...
test("makeFunction creates a JavaScript function from a Kenpali expression returning a given", (t) => {
  const expression = given({}, literal(42));
